...
document.head.innerHTML += `<script src="https://cdn.jsdelivr.net/npm/hls.js@latest"></script>`;
...
const RxPlayer = (() => {
    ...
    function loadHLS(src) {
        if (Hls.isSupported()) {
                ...
                if (data.fatal) {
                    switch (data.type) {
                        ...
                        case Hls.ErrorTypes.MEDIA_ERROR:
                            ...
                            break;
                        default:
                            console.error("Critical error, destroying instance...");
                            hls.destroy();
                            break;
                    }
                }
            ...
            t.video.src = src;
            t.video.addEventListener('loadedmetadata', function () {
                t.video.play();
            });
        } else {
    ...
    function enablePiP() {
        if (t.video.requestPictureInPicture) {
    ...
    function updateProgress() {
        if (!t || !t.video) return;
        const { video, progressBar, currentTime, duration } = t;
        if (!video.paused) {
